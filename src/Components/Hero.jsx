    ...
    <div className=" text-black bg-[url('/image/myPic.png')] w-screen h-screen bg-cover bg-center py-16 px-4 sm:px-10 lg:px-20">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        <div className="max-w-xl text-center lg:text-left">
          <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl mt-1 md:mt-20 leading-snug">Hi, I am</h1>
          <h1 className="mt-2 font-bold text-3xl md:text-4xl  text-red-600 sm:text-3xl ">
            Gulfam Awan
          </h1>
          ...
          <h3 className="md:text-4xl sm:text-3xl px-2 font-bold mt-2">
            ...
            <span
              ref={textRef}
              className="text-3xl md:text-4xl mt-0transition-opacity opacity-100 text-blue-400 duration-500"
            >
              Software Developer
            </span>
          </h3>
